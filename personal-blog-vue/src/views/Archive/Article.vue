    ...
    <div v-if="article" class="main-container">
      <div class="left-container" :class="appStore.sideFlag ? 'w-full' : ''">
        <div class="article-container">
          <VMdPreview ref="articleRef" class="md" :text="article.article_content"></VMdPreview>
          <div class="article-post">
            <div class="tag-share">
              <router-link v-for="tag in article.tag_name_list" :key="tag" :to="`/tag/${tag}`" class="article-tag">
            ...
            <div class="reward">
              ...
              <n-popover v-if="blogStore.blogInfo.website_config.website_feature.is_reward" trigger="click">
                <template #trigger>
                ...
                <div class="reward-all">
                  <span>
                    <img v-lazy="blogStore.blogInfo.website_config.reward_qr_code.weixin_qr_code" class="reward-img" />
                    <div class="reward-desc">微信</div>
                  </span>
                  <span style="margin-left: 0.3rem">
                    <img v-lazy="blogStore.blogInfo.website_config.reward_qr_code.alipay_qr_code" class="reward-img" />
            ...
            <div class="post-nav">
              <div v-if="article.last_article" class="item">
                <router-link :to="`/article/${article.last_article?.id}`" class="post-cover"
              ...
              <div v-if="article.next_article" class="item">
                <router-link :to="`/article/${article.next_article?.id}`" class="post-cover"
...
import { computed, onMounted, reactive, toRefs, ref, type Ref } from "vue";
import { useRoute } from "vue-router";
import VMdPreview from "@kangc/v-md-editor/lib/preview";
import type { VMdPreviewInstance } from "@kangc/v-md-editor/lib/preview";
...
const articleRef: Ref<VMdPreviewInstance | null> = ref(null);
