<template>
  <div v-for="article of articleList" :key="article.id" v-animate="['slideUpBigIn']" class="article-item">
    <!-- 文章缩略图 -->
    ...
    <div class="article-info">
      <div class="article-meta">
        ...
        <!-- 文章标签 -->
        <router-link v-for="tag in article.tag_name_list" :key="tag" class="meta-item ml-3.75" :to="`/tag/${tag}`">
      ...
      <div class="article-category">
        ...
        <router-link :to="`/category/${article.category_name}`">{{ article.category_name }}
        </router-link>
      </div>
      <!-- 阅读按钮 -->
