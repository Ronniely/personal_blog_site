<template>
  ...
  <div class="message-container">
    ...
    <div class="message-input">
      <input v-model="addMessageContent" class="input" placeholder="说点什么吧" @click="show = true"
  ...
  <div class="danmaku-container">
    <vue-danmaku ref="danmaku" v-model:danmus="messageList" class="danmaku" use-slot :is-suspend="true" v-bind="config">
      <template v-slot:dm="{ index, danmu }">
        <span class="danmaku-item">
          <img :src="danmu.user?.avatar || touristAvatar" width="30" height="30" style="border-radius: 50%" alt="" />
