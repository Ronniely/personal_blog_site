  ...
  <div>
    <div v-show="show" class="chat-container">
      ...
      <div id="chat-content" class="chat-content">
        <div v-for="(chat, index) of recordList" class="chat-item" :class="isMy(chat) ? 'my-chat' : ''">
      ...
      <div class="chat-footer">
        <textarea v-model="chatContent" class="chat-input" placeholder="开始聊天吧"
...
// 注意：这里暂时注释掉 STOMP 相关导入，因为缺少依赖
// import { Client, type IMessage } from "@stomp/stompjs";
import { getTerminalId, getToken, getUid } from "../../utils/token";

// 添加 Vue 相关导入
import { ref, reactive, toRefs, computed, onUpdated, onBeforeUnmount } from 'vue';

// 使用对象代替 enum（解决 erasableSyntaxOnly 问题）
const Type = {
  ONLINE_COUNT: 1, // 在线人数
...
const handleSend = () => {
  ...
  let chat: ChatMessageEvent = {
    ...
    terminal_id: getTerminalId() || "", // 添加默认值以解决类型问题
